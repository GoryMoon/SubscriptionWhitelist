            ...
            <b-tabs v-model="selectedTab" content-class="mt-3">
                <b-tab title="Pledge amount">
                    <b-form-group>
                        ...
                        <b-form-input v-model="centMin" type="number" class="mb-2 mr-sm-2" id="patreon_cent_min" placeholder="100"></b-form-input>
                    </b-form-group>
                    <b-form-group>
                        ...
                        <b-form-input v-model="centMax" type="number" class="mb-2 mr-sm-2" id="patreon_cent_max" placeholder="1000"></b-form-input>
                    </b-form-group>
                </b-tab>
                <b-tab title="Tier">
                    ...
                    <b-form-group>
                        <b-form-select v-model="tierSelected" :options="options">
                            <template #first>
                                <b-form-select-option :value="null" disabled>Please select a tier</b-form-select-option>
                            </template>
                        </b-form-select>
                    </b-form-group>
                </b-tab>
